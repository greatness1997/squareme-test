...
import StartimesCard from '../../../components/StartimesCard';




const StartimesCompleted = ({ navigation, route }) => {

    const completeData = route.params
console.log(completeData, "from log")
    return (
...
export default StartimesCompleted