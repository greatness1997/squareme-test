        ...
        <>
            <View style={{ flexDirection: "row", marginTop: s(30), justifyContent: "space-between", alignItems: "center", padding: s(10) }}>
                ...
                <View style={{ justifyContent: "center" }}>
                    <Text style={{ fontSize: s(18), fontWeight: "500", color: "black" }}>{name.toUpperCase()}</Text>
                </View>
                        ...
                        return (
                            <>
                                ...
                                <Text style={{ marginLeft: 5, marginBottom: 15, color: "#c66e54", fontSize: 12 }}>Min. amount ₦1000 </Text> */}
                                    ...
                                    {nam && <Text style={{ marginLeft: 5, color: "grey" }}>Bouquet</Text>}
                                ...
                                {bouquet ? <Text style={{ marginBottom: 20, color: "grey", fontWeight: "500", fontSize: s(13), alignSelf: "center" }}>Select A Bouquet</Text> :
                                    <Text style={{ marginBottom: 20, fontWeight: "500", color: "grey", fontSize: s(13), alignSelf: "center" }}>Cannot get Bouquet List</Text>}
