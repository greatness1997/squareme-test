    ...
    return (
        <ScrollView>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingLeft: ms(20), paddingRight: ms(20) }}>
                <View>
                    <Image source={LogoBlue} style={{ flex: 1, resizeMode: 'contain', width: s(70), height: vs(60) }} />
                    <Text style={{ fontSize: s(14), fontWeight: "500", color: "#9A9A9A" }}>Welcome Back,</Text>
                </View>
                <MaterialCommunityIcons name="bell" size={s(30)} color="#69788B" />
            </View>
            <ImageBackground
            ...
            >
                <View style={{ marginTop: vs(15) }}>
                    ...
                    <View style={{ flexDirection: "row", paddingLeft: ms(30), paddingRight: ms(30), marginTop: s(12) }}>
                        <View>
                        ...
                        <View style={{ width: "100%", height: "100%", marginLeft: '35%' }}>
                            <Image source={Logo} style={{ flex: 1, resizeMode: 'contain', width: s(60), height: ms(60) }} />
                        </View>
                    </View>
                    ...
                    <View style={{ flexDirection: "row", paddingLeft: ms(30), paddingRight: ms(30) }}>
                        ...
                        <TouchableOpacity style={styles.sendIcon} onPress={() => navigation.navigate("TransferValidate")}>
                            <Image source={Send} style={{ height: ms(50), width: s(50), borderRadius: s(50) }} />
                            <Text style={{ marginLeft: s(8), fontSize: s(12), fontWeight: '500', color: 'white' }}>Send Money</Text>
                        </TouchableOpacity>
            ...
            <View style={{ flexDirection: "row", flexWrap: "wrap", justifyContent: "space-around", padding: 0, marginTop: 0, width: "100%" }}>
