...
const ScreenOne = ({ navigation }) => {
    ...
    const Schema = Yup.object().shape({
        ...
        nokEmail: Yup.string().required('Next of kin email is required'),
                                ...
                                return (
                                    <View style={{ marginTop: s(20) }}>
                                        ...
                                        <View style={{ flexDirection: "row", justifyContent: "space-between", marginTop: 5 }}>
                                            ...
                                            <View style={styles.formContainer4}>
                                                <Text style={{ color: "#A0A0A0", marginBottom: s(10), fontSize: s(10), marginBottom: s(7) }}>Gender</Text>
                                                <TextInput
                                                    style={styles.input}
                                        ...
                                        <AppButton title="Next To Guarantors Info" onPress={handleSubmit} style={{ backgroundColor: "#060C27", height: s(60), marginTop: s(30) }} />
                                    </View>
                                );
                            }}
                        </Formik>
