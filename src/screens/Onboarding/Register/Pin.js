...
const Pin = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: s(20), marginTop: s(20) }}>
                <MaterialCommunityIcon name="arrow-left" size={25} color="black" />
                <Text style={{ fontSize: s(18), fontWeight: "600", color: "black" }}>Set Your Security Pin</Text>
                <Text></Text>
            </View>

            <View style={{ paddingLeft: s(30), paddingRight: s(30), marginTop: s(20), alignItems: "center" }}>
